<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListStudent.aspx.cs" Inherits="AppUsuarios.ListStudent" %>
    ...
    <div>
         <nav class="navbar navbar-default">
           ...
           <h1 align="center">Listado de Alumnos</h1>
             ...
             <asp:GridView ID="gridAlumnos" runat="server" class="table table-hover">
        </asp:GridView>
